module.exports = {
  ...
  rules: {
    ...
    'capitalized-comments': [
      ...
      'always',
      {
        /* ( f) enforce or disallow capitalization of the first letter of a comment */
    ...
    'multiline-comment-style': [
      'error',
      'starred-block',
    ] /* ( f) enforce a particular style for multiline comments */,
    'multiline-ternary': [
      'error',
      'always-multiline',
    ...
    'no-multiple-empty-lines': [
      'error',
      {
        /* ( f) disallow multiple empty lines */ max: 1,
        maxBOF: 0,
        maxEOF: 1,
      },
    ],
    ...
    '@typescript-eslint/explicit-function-return-type':
      'error' /* (  ) Require explicit return types on functions and class methods */,
    ...
    '@typescript-eslint/no-empty-interface':
      'error' /* (rf ) Disallow the declaration of empty interfaces */,
    ...
    '@typescript-eslint/no-unnecessary-condition':
      'error' /* ( ft) Prevents conditionals where the type is always truthy or always falsy */,
    ...
    '@typescript-eslint/no-unsafe-argument':
      'error' /* (  t) Disallows calling an function with an any type value */,
    '@typescript-eslint/no-unsafe-assignment':
      'error' /* (r t) Disallows assigning any to variables and properties */,
