            ...
            embeds: [
              {
                ...
                description: `Hey, ${p.name}! The replays uploaded for your ${
                  organizationBrandingResult.data.name
                } ${
                  isLFS ? 'LFS ' : ''
                }scrim have finished processing and are ready to be ratified. Verify they are correct and ratify them [here](${
                  config.web.url
                }/scrims).`,
                author: {
