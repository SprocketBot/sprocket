module.exports = {
	...
	ignorePatterns: ["*.cjs", ".eslintrc.js", "jest.config.js", "commitlint.config.js", "*.stories.svelte", "docs"],
	overrides: [
		{
			files: ["*.svelte"],
	...
	rules: {
		...
		"@typescript-eslint/no-empty-interface": "off",                            /* (rf ) Disallow the declaration of empty interfaces */
