module.exports = {
  ...
  rules: {
    ...
    'for-direction':
      'error' /* (r ) enforce "for" loop update clause moving the counter in the right direction. */,
    'getter-return': 'error' /* (r ) enforce `return` statements in getters */,
    'no-async-promise-executor':
      'error' /* (r ) disallow using an async function as a Promise executor */,
    ...
    'no-empty-character-class':
      'error' /* (r ) disallow empty character classes in regular expressions */,
    ...
    'no-inner-declarations':
      'error' /* (r ) disallow variable or `function` declarations in nested blocks */,
    'no-invalid-regexp':
      'error' /* (r ) disallow invalid regular expression strings in `RegExp` constructors */,
    ...
    'no-misleading-character-class':
      'error' /* (r ) disallow characters which are made with multiple code points in character class syntax */,
    'no-obj-calls': 'error' /* (r ) disallow calling global object properties as functions */,
    'no-promise-executor-return':
      'error' /* (  ) disallow returning values from Promise executor functions */,
    'no-prototype-builtins':
      'error' /* (r ) disallow calling some `Object.prototype` methods directly on objects */,
    ...
    'no-template-curly-in-string':
      'error' /* (  ) disallow template literal placeholder syntax in regular strings */,
    'no-unexpected-multiline': 'error' /* (r ) disallow confusing multiline expressions */,
    'no-unreachable':
      'error' /* (r ) disallow unreachable code after `return`, `throw`, `continue`, and `break` statements */,
    'no-unreachable-loop':
      'error' /* (  ) disallow loops with a body that allows only one iteration */,
    'no-unsafe-finally': 'error' /* (r ) disallow control flow statements in `finally` blocks */,
    'no-unsafe-negation':
      'error' /* (r ) disallow negating the left operand of relational operators */,
    'no-unsafe-optional-chaining':
      'error' /* (  ) disallow use of optional chaining in contexts where the `undefined` value is not allowed */,
    'no-useless-backreference':
      'off' /* (  ) disallow useless backreferences in regular expressions */,
    'require-atomic-updates':
      'error' /* (  ) disallow assignments that can lead to race conditions due to usage of `await` or `yield` */,
    ...
    'array-callback-return':
      'error' /* (  ) enforce `return` statements in callbacks of array methods */,
    'block-scoped-var':
      'error' /* (  ) enforce the use of variables within the scope they are defined */,
    ...
    'dot-location': [
      'error',
      'property',
    ] /* ( f) enforce consistent newlines before and after dots */,
    ...
    'grouped-accessor-pairs':
      'error' /* (  ) require grouped accessor pairs in object literals and classes */,
    ...
    'no-div-regex':
      'off' /* ( f) disallow division operators explicitly at the beginning of regular expressions */,
    'no-else-return':
      'error' /* ( f) disallow `else` blocks after `return` statements in `if` statements */,
    ...
    'no-floating-decimal':
      'error' /* ( f) disallow leading or trailing decimal points in numeric literals */,
    'no-global-assign':
      'error' /* (r ) disallow assignments to native objects or read-only global variables */,
    ...
    'no-invalid-this':
      'off' /* (  ) disallow `this` keywords outside of classes or class-like objects */, // Disabled in favor of typescript-eslint rule below
    'no-iterator': 'error' /* (  ) disallow the use of the `__iterator__` property */,
    'no-labels': 'error' /* (  ) disallow labeled statements */,
    'no-lone-blocks': 'error' /* (  ) disallow unnecessary nested blocks */,
    'no-loop-func':
      'off' /* (  ) disallow function declarations that contain unsafe references inside loop statements */, // Disabled in favor of typescript-eslint rule below
    ...
    'no-nonoctal-decimal-escape':
      'error' /* (  ) disallow `\8` and `\9` escape sequences in string literals */,
    ...
    'prefer-named-capture-group':
      'off' /* (  ) enforce using named capture group in regular expression */,
    'prefer-promise-reject-errors':
      'error' /* (  ) require using Error objects as Promise rejection reasons */,
    'prefer-regex-literals':
      'error' /* (  ) disallow use of the `RegExp` constructor in favor of regular expression literals */,
    radix: [
      'error',
      'as-needed',
    ...
    'wrap-iife': [
      'error',
      'inside',
    ] /* ( f) require parentheses around immediate `function` invocations */,
    yoda: [
      'error',
      'never',
      {
        /* ( f) require or disallow "Yoda" conditions */ exceptRange: true,
      },
    ],
    ...
    'no-shadow':
      'off' /* (  ) disallow variable declarations from shadowing variables declared in the outer scope */, // Disabled in favor of typescript-eslint rule below
    'no-shadow-restricted-names':
      'error' /* (r ) disallow identifiers from shadowing restricted names */,
    'no-undef':
      'error' /* (r ) disallow the use of undeclared variables unless mentioned in `global` comments */,
    ...
    'array-bracket-newline': [
      'error',
      'consistent',
    ] /* ( f) enforce linebreaks after opening and before closing array brackets */,
    'array-bracket-spacing': [
      'error',
      'never',
      {
        /* ( f) enforce consistent spacing inside array brackets */ objectsInArrays: true,
        arraysInArrays: true,
      },
    ],
    'array-element-newline': [
      'error',
      'consistent',
    ] /* ( f) enforce line breaks after each array element */,
    'block-spacing': [
      'error',
      'always',
    ] /* ( f) disallow or enforce spaces inside of blocks after opening block and before closing block */,
    ...
    'capitalized-comments':
      'off' /* ( f) enforce or disallow capitalization of the first letter of a comment */,
    ...
    'computed-property-spacing': [
      'error',
      'never',
    ] /* ( f) enforce consistent spacing inside computed property brackets */,
    'consistent-this':
    ...
    'func-call-spacing':
      'off' /* ( f) require or disallow spacing between function identifiers and their invocations */, // Disabled in favor of typescript-eslint rule below
    'func-name-matching': [
      'error',
      'always',
    ...
    'function-call-argument-newline': [
      'error',
      'consistent',
    ] /* ( f) enforce line breaks between arguments of a function call */,
    'function-paren-newline': [
      'error',
      'multiline',
    ] /* ( f) enforce consistent line breaks inside function parentheses */,
    ...
    'implicit-arrow-linebreak': [
      'error',
      'beside',
    ] /* ( f) enforce the location of arrow function bodies */,
    indent: 'off' /* ( f) enforce consistent indentation */, // Disabled in favor of typescript-eslint rule below
    'jsx-quotes':
      'error' /* ( f) enforce the consistent use of either double or single quotes in JSX attributes */,
    'key-spacing': [
      'error',
      {
        /* ( f) enforce consistent spacing between keys and values in object literal properties */
        beforeColon: false,
        afterColon: true,
        mode: 'minimum',
      },
    ...
    'lines-between-class-members':
      'off' /* ( f) require or disallow an empty line between class members */, // Disabled in favor of typescript-eslint rule below
    ...
    'max-lines-per-function':
      'off' /* (  ) enforce a maximum number of lines of code in a function */,
    ...
    'max-statements-per-line':
      'off' /* (  ) enforce a maximum number of statements allowed per line */,
    ...
    'multiline-ternary': [
      'error',
      'always-multiline',
    ] /* ( f) enforce newlines between operands of ternary expressions */,
    'new-cap': 'off' /* (  ) require constructor names to begin with a capital letter */, // Turned off because this gets mad on decorators
    'new-parens': [
      'error',
      'always',
    ] /* ( f) enforce or disallow parentheses when invoking a constructor with no arguments */,
    'newline-per-chained-call': [
      'error',
      {
        /* ( f) require a newline after each call in a method chain */ ignoreChainWithDepth: 2,
      },
    ],
    ...
    'no-lonely-if':
      'error' /* ( f) disallow `if` statements as the only statement in `else` blocks */,
    ...
    'no-multiple-empty-lines': [
      'error',
      {
        /* ( f) disallow multiple empty lines */ max: 3,
        maxBOF: 0,
        maxEOF: 1,
      },
    ],
    ...
    'no-trailing-spaces': [
      'error',
      {
        /* ( f) disallow trailing whitespace at the end of lines */ skipBlankLines: true,
      },
    ],
    'no-underscore-dangle': 'off' /* (  ) disallow dangling underscores in identifiers */,
    'no-unneeded-ternary':
      'error' /* ( f) disallow ternary operators when simpler alternatives exist */,
    'no-whitespace-before-property': 'error' /* ( f) disallow whitespace before properties */,
    'nonblock-statement-body-position': [
      'error',
      'beside',
    ] /* ( f) enforce the location of single-line statements */,
    'object-curly-newline': [
      'error',
      {
        /* ( f) enforce consistent line breaks after opening and before closing braces */
        multiline: true,
        minProperties: 3,
        consistent: true,
      },
    ...
    'one-var':
      'off' /* ( f) enforce variables to be declared either together or separately in functions */,
    'one-var-declaration-per-line': [
      'error',
      'always',
    ] /* ( f) require or disallow newlines around variable declarations */,
    'operator-assignment':
      'off' /* ( f) require or disallow assignment operator shorthand where possible */,
    'operator-linebreak': [
      'error',
      'before',
    ] /* ( f) enforce consistent linebreak style for operators */,
    'padded-blocks': 'off' /* ( f) require or disallow padding within blocks */,
    'padding-line-between-statements':
      'off' /* ( f) require or disallow padding lines between statements */,
    'prefer-exponentiation-operator':
      'off' /* ( f) disallow the use of `Math.pow` in favor of the `**` operator */,
    'prefer-object-spread':
      'off' /* ( f) disallow using Object.assign with an object literal as the first argument and prefer the use of object spread instead. */,
    'quote-props': [
      'error',
      'consistent',
    ] /* ( f) require quotes around object literal property names */,
    quotes:
      'off' /* ( f) enforce the consistent use of either backticks, double, or single quotes */, // Disabled in favor of typescript-eslint rule below
    semi: 'off' /* ( f) require or disallow semicolons instead of ASI */, // Disabled in favor of typescript-eslint rule below
    'semi-spacing': [
      'error',
      {
        /* ( f) enforce consistent spacing before and after semicolons */ before: false,
        after: false,
      },
    ],
    ...
    'sort-vars': [
      'error',
      {
        /* ( f) require variables within the same declaration block to be sorted */
        ignoreCase: true,
      },
    ],
    'space-before-blocks': ['error', 'always'] /* ( f) enforce consistent spacing before blocks */,
    'space-before-function-paren':
      'off' /* ( f) enforce consistent spacing before `function` definition opening parenthesis */, // Disabled in favor of typescript-eslint rule below
    ...
    'space-unary-ops': [
      'error',
      {
        /* ( f) enforce consistent spacing before or after unary operators */ words: true,
        nonwords: false,
      },
    ],
    'spaced-comment': [
      ...
      'always',
      {
        /* ( f) enforce consistent spacing after the `//` or `/*` in a comment */
        block: {
          balanced: true,
        },
      },
    ...
    'switch-colon-spacing': [
      'error',
      {
        /* ( f) enforce spacing around colons of switch statements */ before: false,
        after: true,
      },
    ],
    'template-tag-spacing': [
      'error',
      'never',
    ] /* ( f) require or disallow spacing between template tags and their literals */,
    ...
    'arrow-body-style': [
      'error',
      'as-needed',
    ] /* ( f) require braces around arrow function bodies */,
    'arrow-parens': [
      'error',
      'as-needed',
    ] /* ( f) require parentheses around arrow function arguments */,
    'arrow-spacing': [
      'error',
      {
        /* ( f) enforce consistent spacing before and after the arrow in arrow functions */
        before: true,
        after: true,
      },
    ],
    ...
    'generator-star-spacing': [
      'error',
      {
        /* ( f) enforce consistent spacing around `*` operators in generator functions */
        before: false,
        after: true,
      },
    ],
    ...
    'no-confusing-arrow': [
      'error',
      {
        /* ( f) disallow arrow functions where they could be confused with comparisons */
        allowParens: true,
      },
    ],
    ...
    'no-this-before-super':
      'error' /* (r ) disallow `this`/`super` before calling `super()` in constructors */,
    'no-useless-computed-key':
      'error' /* ( f) disallow unnecessary computed property keys in objects and classes */,
    ...
    'prefer-numeric-literals':
      'error' /* ( f) disallow `parseInt()` and `Number.parseInt()` in favor of binary, octal, and hexadecimal literals */,
    ...
    'rest-spread-spacing': [
      'error',
      'never',
    ] /* ( f) enforce spacing between rest and spread operators and their expressions */,
    ...
    'template-curly-spacing': [
      'error',
      'never',
    ] /* ( f) require or disallow spacing around embedded expressions of template strings */,
    'yield-star-spacing': [
      'error',
      {
        /* ( f) require or disallow spacing around the `*` in `yield*` expressions */ before: false,
        after: true,
      },
    ],
    ...
    '@typescript-eslint/adjacent-overload-signatures':
      'error' /* (r  ) Require that member overloads be consecutive */,
    '@typescript-eslint/array-type': [
      'error',
      {
        /* (  f) Requires using either T[] or Array<T> for arrays */ default: 'array-simple',
      },
    ],
    '@typescript-eslint/await-thenable':
      'error' /* (r t) Disallows awaiting a value that is not a Thenable */,
    '@typescript-eslint/ban-ts-comment': [
      'error',
      {
        /* (r  ) Bans @ts-<directive> comments from being used or requires descriptions after directive */
    ...
    '@typescript-eslint/ban-tslint-comment':
      'error' /* ( f ) Bans // tslint:<rule-flag> comments from being used */,
    '@typescript-eslint/ban-types': 'off' /* (rf ) Bans specific types from being used */,
    '@typescript-eslint/class-literal-property-style':
      'off' /* ( f ) Ensures that literals on classes are exposed in a consistent style */,
    '@typescript-eslint/consistent-indexed-object-style': [
      'error',
      'record',
    ] /* ( f ) Enforce or disallow the use of the record type */,
    '@typescript-eslint/consistent-type-assertions': [
      'error',
      {
        /* (  ) Enforces consistent usage of type assertions */ assertionStyle: 'as',
      },
    ],
    '@typescript-eslint/consistent-type-definitions': [
      'error',
      'interface',
    ] /* ( f ) Consistent with type definition either interface or type */,
    '@typescript-eslint/consistent-type-imports': [
      'error',
      {
        /* ( f ) Enforces consistent usage of type imports */ prefer: 'type-imports',
      },
    ],
    '@typescript-eslint/explicit-function-return-type':
      'off' /* (  ) Require explicit return types on functions and class methods */, // Disabled because this breaks when specifying callbacks in HTML markup in .svelte files
    '@typescript-eslint/explicit-member-accessibility': [
      'error',
      {
        /* ( f ) Require explicit accessibility modifiers on class properties and methods */
        accessibility: 'no-public',
      },
    ],
    '@typescript-eslint/explicit-module-boundary-types':
      'error' /* (r  ) Require explicit return and argument types on exported functions' and classes' public class methods */,
    '@typescript-eslint/member-delimiter-style': [
      'error',
      {
        /* ( f ) Require a specific member delimiter style for interfaces and type literals */
        multiline: {
          delimiter: 'semi',
          requireLast: true,
        },
    ...
    '@typescript-eslint/member-ordering':
      'error' /* (   ) Require a consistent member declaration order */,
    '@typescript-eslint/method-signature-style':
      'off' /* ( f ) Enforces using a particular method signature syntax. */,
    '@typescript-eslint/naming-convention':
      'off' /* (  t) Enforces naming conventions for everything across a codebase */,
    '@typescript-eslint/no-base-to-string':
      'error' /* (  t) Requires that .toString() is only called on objects which provide useful information when stringified */,
    '@typescript-eslint/no-confusing-non-null-assertion':
      'error' /* ( f ) Disallow non-null assertion in locations that may be confusing */,
    '@typescript-eslint/no-confusing-void-expression':
      'error' /* ( ft) Requires expressions of type void to appear in statement position */,
    '@typescript-eslint/no-dynamic-delete':
      'error' /* ( f ) Disallow the delete operator with computed key expressions */,
    '@typescript-eslint/no-empty-interface':
      'off' /* (rf ) Disallow the declaration of empty interfaces */,
    '@typescript-eslint/no-explicit-any': 'error' /* (rf ) Disallow usage of the any type */,
    '@typescript-eslint/no-extra-non-null-assertion':
      'error' /* (rf ) Disallow extra non-null assertion */,
    '@typescript-eslint/no-extraneous-class': [
      'error',
      {
        /* (   ) Forbids the use of classes as namespaces */ allowEmpty: true,
      },
    ],
    '@typescript-eslint/no-floating-promises':
      'error' /* (r t) Requires Promise-like values to be handled appropriately */,
    '@typescript-eslint/no-for-in-array':
      'error' /* (r t) Disallow iterating over an array with a for-in loop */,
    '@typescript-eslint/no-implicit-any-catch':
      'off' /* ( f ) Disallow usage of the implicit any type in catch clauses */,
    '@typescript-eslint/no-inferrable-types':
      'off' /* (rf ) Disallows explicit type declarations for variables or parameters initialized to a number, string, or boolean */,
    '@typescript-eslint/no-invalid-void-type':
      'error' /* (   ) Disallows usage of void type outside of generic or return types */,
    '@typescript-eslint/no-misused-new':
      'error' /* (r  ) Enforce valid definition of new and constructor */,
    '@typescript-eslint/no-misused-promises':
      'error' /* (r t) Avoid using promises in places not designed to handle them */,
    '@typescript-eslint/no-namespace':
      'error' /* (r  ) Disallow the use of custom TypeScript modules and namespaces */,
    '@typescript-eslint/no-non-null-asserted-optional-chain':
      'error' /* (r  ) Disallows using a non-null assertion after an optional chain expression */,
    '@typescript-eslint/no-non-null-assertion':
      'off' /* (r  ) Disallows non-null assertions using the ! postfix operator */,
    '@typescript-eslint/no-parameter-properties':
      'off' /* (   ) Disallow the use of parameter properties in class constructors */,
    ...
    '@typescript-eslint/no-unnecessary-boolean-literal-compare':
      'error' /* ( ft) Flags unnecessary equality comparisons against boolean literals */,
    '@typescript-eslint/no-unnecessary-condition':
      'off' /* ( ft) Prevents conditionals where the type is always truthy or always falsy */, // Turned off because when checking for optional props (initialized to undefined), eslint will think its a falsy comparison
    '@typescript-eslint/no-unnecessary-qualifier':
      'error' /* ( ft) Warns when a namespace qualifier is unnecessary */,
    '@typescript-eslint/no-unnecessary-type-arguments':
      'off' /* ( ft) Enforces that type arguments will not be used if not required */,
    '@typescript-eslint/no-unnecessary-type-assertion':
      'error' /* (rft) Warns if a type assertion does not change the type of an expression */,
    '@typescript-eslint/no-unnecessary-type-constraint':
      'error' /* ( f ) Disallows unnecessary constraints on generic types */,
    '@typescript-eslint/no-unsafe-argument':
      'off' /* (  t) Disallows calling an function with an any type value */, // Disabled because this doesn't play nicely with svelte
    '@typescript-eslint/no-unsafe-assignment':
      'off' /* (r t) Disallows assigning any to variables and properties */, // Disabled because this doesn't play nicely with svelte
    ...
    '@typescript-eslint/no-unsafe-member-access':
      'off' /* (r t) Disallows member access on any typed variables */,
    '@typescript-eslint/no-unsafe-return':
      'error' /* (r t) Disallows returning any from a function */,
    '@typescript-eslint/no-var-requires':
      'error' /* (r  ) Disallows the use of require statements except in import statements */,
    '@typescript-eslint/non-nullable-type-assertion-style':
      'error' /* ( ft) Prefers a non-null assertion over explicit type cast when possible */,
    '@typescript-eslint/prefer-as-const':
      'error' /* (rf ) Prefer usage of as const over literal type */,
    '@typescript-eslint/prefer-enum-initializers':
      'error' /* (   ) Prefer initializing each enums member value */,
    ...
    '@typescript-eslint/prefer-function-type':
      'error' /* ( f ) Use function types instead of interfaces with call signatures */,
    '@typescript-eslint/prefer-includes':
      'error' /* ( ft) Enforce includes method over indexOf method */,
    ...
    '@typescript-eslint/prefer-readonly':
      'off' /* ( ft) Requires that private members are marked as readonly if they're never modified outside of the constructor */,
    '@typescript-eslint/prefer-readonly-parameter-types':
      'off' /* (  t) Requires that function parameters are typed as readonly to prevent accidental mutation of inputs */,
    '@typescript-eslint/prefer-reduce-type-parameter':
      'error' /* ( ft) Prefer using type parameter when calling Array#reduce instead of casting */,
    '@typescript-eslint/prefer-regexp-exec':
      'off' /* (rft) Enforce that RegExp#exec is used instead of String#match if no global flag is provided */,
    '@typescript-eslint/prefer-string-starts-ends-with':
      'error' /* ( ft) Enforce the use of String#startsWith and String#endsWith instead of other equivalent methods of checking substrings */,
    '@typescript-eslint/prefer-ts-expect-error':
      'error' /* ( f ) Recommends using @ts-expect-error over @ts-ignore */,
    '@typescript-eslint/promise-function-async':
      'error' /* ( ft) Requires any function or method that returns a Promise to be marked async */,
    '@typescript-eslint/require-array-sort-compare': [
      'error',
      {
        /* (  t) Requires Array#sort calls to always provide a compareFunction */
        ignoreStringArrays: true,
      },
    ],
    '@typescript-eslint/restrict-plus-operands':
      'error' /* (r t) When adding two variables, operands must both be of type number or of type string */,
    '@typescript-eslint/restrict-template-expressions':
      'off' /* (r t) Enforce template literal expressions to be of string type */,
    '@typescript-eslint/sort-type-union-intersection-members':
      'off' /* ( f ) Enforces that members of a type union/intersection are sorted alphabetically */,
    '@typescript-eslint/strict-boolean-expressions':
      'off' /* ( ft) Restricts the types allowed in boolean expressions */,
    '@typescript-eslint/switch-exhaustiveness-check':
      'error' /* (  t) Exhaustiveness checking in switch with union type */,
    '@typescript-eslint/triple-slash-reference':
      'error' /* (r  ) Sets preference level for triple slash directives versus ES6-style import declarations */,
    '@typescript-eslint/type-annotation-spacing': [
      'error',
      {
        /* ( f ) Require consistent spacing around type annotations */ before: false,
        after: true,
    ...
    '@typescript-eslint/unbound-method':
      'error' /* (r t) Enforces unbound methods are called with their expected scope */,
    ...
    '@typescript-eslint/brace-style': [
      ...
      '1tbs',
      {
        /* (  f) Enforce consistent brace style for blocks */ allowSingleLine: true,
      },
    ],
    '@typescript-eslint/comma-dangle': [
      'error',
      'always-multiline',
    ] /* ( f ) Require or disallow trailing comma */,
    '@typescript-eslint/comma-spacing': [
      'error',
      {
        /* ( f ) Enforces consistent spacing before and after commas */ before: false,
        after: true,
      },
    ],
    '@typescript-eslint/default-param-last':
      'error' /* (   ) Enforce default parameters to be last */,
    '@typescript-eslint/dot-notation': 'error' /* ( ft) enforce dot notation whenever possible */,
    '@typescript-eslint/func-call-spacing':
      'error' /* ( f ) Require or disallow spacing between function identifiers and their invocations */,
    '@typescript-eslint/indent': [
      'error',
      4,
      {
        /* ( f ) Enforce consistent indentation */ SwitchCase: 1,
    ...
    '@typescript-eslint/keyword-spacing': [
      'error',
      {
        /* ( f ) Enforce consistent spacing before and after keywords */ before: true,
        after: true,
      },
    ],
    '@typescript-eslint/lines-between-class-members': [
      'error',
      'always',
    ] /* ( f ) Require or disallow an empty line between class members */,
    '@typescript-eslint/no-array-constructor':
      'error' /* (rf ) Disallow generic Array constructors */,
    ...
    '@typescript-eslint/no-implied-eval':
      'error' /* (r t) Disallow the use of eval()-like methods */,
    '@typescript-eslint/no-invalid-this':
      'error' /* (   ) Disallow this keywords outside of classes or class-like objects */,
    '@typescript-eslint/no-loop-func':
      'error' /* (   ) Disallow function declarations that contain unsafe references inside loop statements */,
    '@typescript-eslint/no-loss-of-precision':
      'error' /* (   ) Disallow literal numbers that lose precision */,
    ...
    '@typescript-eslint/no-shadow':
      'error' /* (   ) Disallow variable declarations from shadowing variables declared in the outer scope */,
    '@typescript-eslint/no-throw-literal':
      'error' /* (  t) Disallow throwing literals as exceptions */,
    ...
    '@typescript-eslint/object-curly-spacing': [
      ...
      'never',
      {
        /* ( f ) Enforce consistent spacing inside braces */ objectsInObjects: true,
    ...
    '@typescript-eslint/quotes': [
      ...
      'double',
      {
        /* ( f ) Enforce the consistent use of either backticks, double, or single quotes */
        allowTemplateLiterals: true,
      },
    ],
    '@typescript-eslint/require-await':
      'off' /* (r t) Disallow async functions which have no await expression */,
    '@typescript-eslint/return-await':
      'error' /* ( ft) Enforces consistent returning of awaited values */,
    '@typescript-eslint/semi': [
      'error',
      'always',
      {
        /* ( f ) Require or disallow semicolons instead of ASI */ omitLastInOneLineBlock: true,
      },
    ],
    '@typescript-eslint/space-before-function-paren': [
      'error',
      {
        /* ( f ) Enforces consistent spacing before function parenthesis */ anonymous: 'never',
        named: 'never',
        asyncArrow: 'always',
      },
    ],
