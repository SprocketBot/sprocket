...
export const CurrentScrimLiveStore = (queryStore: CurrentScrimStore, subStore: CurrentScrimSubStore, eventMap?: Partial<Record<CurrentScrimSub$result["followCurrentScrim"]["event"], () => void>>): Readable<CurrentScrim$result["getCurrentScrim"]> => {
