<script lang="ts">
    ...
    import {RatifySubmissionStore} from "$houdini";
    import {GameCard, Progress} from "../../index";
    import {RejectSubmissionModal} from "$lib/components";
    ...
    async function ratifyScrim() {
        const mutator = new RatifySubmissionStore();
...
<RejectSubmissionModal bind:open={rejecting} submissionId={submission.id} />