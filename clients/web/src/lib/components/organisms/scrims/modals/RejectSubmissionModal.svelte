...
<Modal title="Reject Replays" bind:visible id="reject-submission-modal">
    <section slot="body">
        ...
        <p>
            Be sure to include any relevant details about <strong
                >which replays are incorrect</strong
            >
            and <strong>how they are incorrect</strong>.
        </p>
        <p>
            Rejecting the submission will get rid of these uploaded replays and
            allow new replays to be uploaded.
        </p>

        <textarea
            placeholder="Replays 1 and 3 are wrong because..."
            bind:value={reason}
        />
