        ...
        <Alert {variant} {dismissible} {withIcon}>
            ...
            <span slot="actions">
                <div class="flex">
                    <button
                        type="button"
                        class="text-white bg-gray-900 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-200 font-medium rounded-lg text-xs px-3 py-1.5 mr-2 text-center inline-flex items-center dark:bg-gray-800 dark:hover:bg-gray-900"
                    >
                        <svg
                            aria-hidden="true"
