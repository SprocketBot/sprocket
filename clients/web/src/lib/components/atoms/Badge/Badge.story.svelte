...
<Hst.Story title="Atoms/Badge">
    <svelte:fragment slot="controls">
        ...
        <Hst.Select title="icon" bind:value={icon} options={IconOptions} />
        <pre class="m-2 p-2 bg-black/20 ">{JSON.stringify({size, color}, null, 2)}</pre>
    </svelte:fragment>
