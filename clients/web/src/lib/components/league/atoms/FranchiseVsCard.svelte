<script lang="ts">
	...
	$: applicableFontVar = primary.luminosity() > secondary.luminosity() ? "text-context-primary" : "text-context-secondary";
...
<div class="flex-1 flex-col items-center gap-2" style="--primary-color: {profile.primaryColor}; --secondary-color: {profile.secondaryColor}">
	<div class="aspect-square rounded-full w-16 h-16 p-2 mx-auto bg-gradient-to-br from-context-primary to-context-secondary flex justify-center items-center">
