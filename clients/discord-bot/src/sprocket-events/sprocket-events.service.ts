...
import {
    ...
    CoreService,
    EventsService,
    EventTopic, PlayerSkillGroupChangedType, ResponseStatus, SprocketEvent, SprocketEventMarshal,
...
export class SprocketEventsService extends SprocketEventMarshal {
    ...
    async updateRoles(payload: PlayerSkillGroupChangedType): Promise<void> {
