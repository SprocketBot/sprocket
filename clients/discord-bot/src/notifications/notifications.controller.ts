...
export class NotificationsController {
  ...
  async sendGuildTextMessage(@Payload() payload: unknown): Promise<boolean> {
    ...
    return this.notificationService.sendGuildTextMessage(
      data.channelId,
      data.payload,
  ...
  async sendDirectMessage(@Payload() payload: unknown): Promise<boolean> {
    ...
    return this.notificationService.sendDirectMessage(
      data.userId,
      data.payload,
      data.brandingOptions,
    );
  ...
  async sendWebhookMessage(@Payload() payload: unknown): Promise<boolean> {
    ...
    return this.notificationService.sendWebhookMessage(
      data.webhookUrl,
      data.payload,
      data.brandingOptions,
    );
