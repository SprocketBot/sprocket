...
function getMinioAccess() {
  ...
  throw new Error(
    'MINIO_ACCESS_KEY environment variable or ./secret/minio-access.txt file required',
  );
}
...
function getMinioSecret() {
  ...
  throw new Error(
    'MINIO_SECRET_KEY environment variable or ./secret/minio-secret.txt file required',
  );
}
