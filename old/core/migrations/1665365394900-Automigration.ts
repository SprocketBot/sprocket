...
export class Automigration1665365394900 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "match" ADD CONSTRAINT "UQ_d2e8052c65eaaca7a07ff1aa52d" UNIQUE ("invalidationId")`);
        await queryRunner.query(`ALTER TABLE "match" ADD CONSTRAINT "FK_d2e8052c65eaaca7a07ff1aa52d" FOREIGN KEY ("invalidationId") REFERENCES "invalidation"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
