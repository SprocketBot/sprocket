...
export class Automigration1658967501286 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "sprocket"."round_parser_enum" AS ENUM('carball', 'ballchasing')`);
        await queryRunner.query(`ALTER TABLE "round" ADD "parser" "sprocket"."round_parser_enum" NOT NULL DEFAULT 'ballchasing'`);
        ...
        await queryRunner.query(`ALTER TABLE "round" ADD "outputPath" character varying NOT NULL DEFAULT ''`);
