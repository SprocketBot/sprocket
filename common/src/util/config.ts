...
export const config = {
  ...
  gql: {
    get url(): string {
      return ConfigResolver.getConfig('GQL_URL', 'gql.url');
    },
  ...
  transport: {
    ...
    get analytics_queue(): string {
      return ConfigResolver.getConfig(
        'TRANSPORT_ANALYTICS_QUEUE',
        'transport.analytics_queue',
        'analytics',
      );
    },
    get matchmaking_queue(): string {
      return ConfigResolver.getConfig(
        'TRANSPORT_MATCHMAKING_QUEUE',
        'transport.matchmaking_queue',
        'matchmaking',
      );
    },
    get notification_queue(): string {
      return ConfigResolver.getConfig(
        'TRANSPORT_NOTIFICATION_QUEUE',
        'transport.notification_queue',
        'notifications',
      );
    },
    ...
    get events_application_key(): string {
      return ConfigResolver.getConfig(
        'TRANSPORT_EVENTS_APPLICATION_KEY',
        'transport.events_application_key',
      );
    },
    get image_generation_queue(): string {
      return ConfigResolver.getConfig(
        'TRANSPORT_IMAGE_GENERATION_QUEUE',
        'transport.image_generation_queue',
      );
    },
