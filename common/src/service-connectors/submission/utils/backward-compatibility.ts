...
export async function convertLegacyRatifiers(
  ...
  return Promise.all(
    legacyRatifiers.map(async (playerId, index) => {
 ...
 */
export function isEnhancedSubmission(
  submission: ReplaySubmission | EnhancedReplaySubmission,
): submission is EnhancedReplaySubmission {
  return (
 ...
 */
export function createCompatibilityWrapper<T extends ReplaySubmission | EnhancedReplaySubmission>(
  submission: T,
): T extends EnhancedReplaySubmission ? EnhancedReplaySubmission : ReplaySubmission {
  return submission as unknown as T extends EnhancedReplaySubmission
