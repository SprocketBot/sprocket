...
| --- | --- | --- |
| `prod` | `main` | `sprocket.mlesports.gg` (API at /graphql, /login, /refresh, /authentication/*, /admin/invalidate-*, /api/*; GET /admin is web), `rabbitMq.sprocket.mlesports.gg` |
| `dev` | `dev` | `dev.sprocket.mlesports.gg` (API at /graphql, /login, /refresh, /authentication/*, /admin/invalidate-*, /api/*; GET /admin is web), … |
| `staging` | `staging` | `staging.sprocket.mlesports.gg` (API at /graphql, /login, /refresh, /authentication/*, /admin/invalidate-*, /api/*; GET /admin is web), … |
