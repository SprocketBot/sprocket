...
export class Automigration1652321292191 implements MigrationInterface {
    name = 'Automigration1652321292191'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "sprocket"."member_restriction" ADD "reason" character varying NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sprocket"."member_restriction" DROP COLUMN "reason"`);
    }
