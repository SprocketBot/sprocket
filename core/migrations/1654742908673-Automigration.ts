...
export class Automigration1654742908673 implements MigrationInterface {
    name = 'Automigration1654742908673'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sprocket"."organization_configuration_key" ADD "type" "sprocket"."organization_configuration_key_type_enum" NOT NULL`);
