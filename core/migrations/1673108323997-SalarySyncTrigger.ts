...
export class SalarySyncTrigger1673108323997 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<void> {
        // This is copy-pasted directly from ../../queries/setup/mledb-salary-sync-triggers.sql
...
`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
DROP TRIGGER IF EXISTS mledb_salary_sync_trigger ON sprocket.player;
DROP FUNCTION IF EXISTS mledb_salary_sync;
`);
    }
