...
const entityMap = {
  ...
  'FranchiseLeadershipAppointment': 'franchise/franchise_leadership_appointment/franchise_leadership_appointment.model',
  'FranchiseProfile': 'franchise/franchise_profile/franchise_profile.model',
  'FranchiseStaffAppointment': 'franchise/franchise_staff_appointment/franchise_staff_appointment.model',
...
function processFile(filePath) {
  ...
  const relativePatterns = [
    { regex: /from\s+['"]\.\.\/database\/organization\/organization['"]/g, replace: "from '$db/organization/organization/organization.model'" },
    { regex: /from\s+['"]\.\.\/\.\.\/database\/organization\/organization['"]/g, replace: "from '$db/organization/organization/organization.model'" },
    { regex: /from\s+['"]\.\.\/database\/organization\/member_profile['"]/g, replace: "from '$db/organization/member_profile/member_profile.model'" },
    { regex: /from\s+['"]\.\.\/\.\.\/database\/organization\/member_profile['"]/g, replace: "from '$db/organization/member_profile/member_profile.model'" },
    { regex: /from\s+['"]\.\.\/database\/organization\/pronouns['"]/g, replace: "from '$db/organization/pronouns/pronouns.model'" },
    { regex: /from\s+['"]\.\.\/\.\.\/database\/organization\/pronouns['"]/g, replace: "from '$db/organization/pronouns/pronouns.model'" },
    { regex: /from\s+['"]\.\.\/database\/franchise\/franchise['"]/g, replace: "from '$db/franchise/franchise/franchise.model'" },
    { regex: /from\s+['"]\.\.\/\.\.\/database\/franchise\/franchise['"]/g, replace: "from '$db/franchise/franchise/franchise.model'" },
    { regex: /from\s+['"]\.\.\/database\/scheduling\/schedule_group['"]/g, replace: "from '$db/scheduling/schedule_group/schedule_group.model'" },
    { regex: /from\s+['"]\.\.\/\.\.\/database\/scheduling\/schedule_group['"]/g, replace: "from '$db/scheduling/schedule_group/schedule_group.model'" },
    { regex: /from\s+['"]\.\.\/database\/scheduling\/schedule_group_type['"]/g, replace: "from '$db/scheduling/schedule_group_type/schedule_group_type.model'" },
    { regex: /from\s+['"]\.\.\/\.\.\/database\/scheduling\/schedule_group_type['"]/g, replace: "from '$db/scheduling/schedule_group_type/schedule_group_type.model'" },
    { regex: /from\s+['"]\.\.\/database\/scheduling\/schedule_fixture['"]/g, replace: "from '$db/scheduling/schedule_fixture/schedule_fixture.model'" },
    { regex: /from\s+['"]\.\.\/\.\.\/database\/scheduling\/schedule_fixture['"]/g, replace: "from '$db/scheduling/schedule_fixture/schedule_fixture.model'" },
  ];
