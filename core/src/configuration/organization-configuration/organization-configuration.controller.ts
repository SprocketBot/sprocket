...
import type {OrganizationConfigurationKeyTypes} from "$db/configuration/organization_configuration_key/organization_configuration_key.enum";
...
export class OrganizationConfigurationController {
    ...
    async getOrganizationConfigurationValue(@Payload() payload: unknown): Promise<OrganizationConfigurationKeyTypes[keyof OrganizationConfigurationKeyTypes]> {
        ...
        return this.organizationConfigurationService.getOrganizationConfigurationValue(
            data.organizationId,
            data.code,
        );
    }
