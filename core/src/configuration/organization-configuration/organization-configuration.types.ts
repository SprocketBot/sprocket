...
import { OrganizationConfigurationAllowedValue } from "../../database/configuration/organization_configuration_allowed_value/organization_configuration_allowed_value.model";
