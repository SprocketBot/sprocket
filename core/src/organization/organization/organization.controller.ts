...
export class OrganizationController {
    ...
    async getOrganizationProfile(
        ...
        return this.organizationService.getOrganizationProfileForOrganization(
            data.id,
        );
    }
    ...
    async getOrganizationDiscordGuildsByGuild(
        ...
        const data =
            CoreSchemas.GetOrganizationDiscordGuildsByGuild.input.parse(
                payload,
            );
        const valueContainingGuildId =
            await this.organizationConfigurationService.findOrganizationConfigurationValue(
                data.guildId,
        ...
        const alternateGuilds =
            await this.organizationConfigurationService.getOrganizationConfigurationValue<
                string[]
            >(
                valueContainingGuildId.organization.id,
    ...
    async getTransactionsWebhook(
        ...
        const data =
            CoreSchemas.GetTransactionsDiscordWebhook.input.parse(payload);
