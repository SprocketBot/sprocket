...
export class ScheduleGroupService {
    ...
    // Some bookkeeping structures
        ...
        ?? this.m_matchRepo.create({
            ...
            const [schedule_fixture, m_fixture] = await this.scheduleFixtureService.createScheduleFixture(
                match_week,
                m_match,
                fixture.home,
                fixture.away,
