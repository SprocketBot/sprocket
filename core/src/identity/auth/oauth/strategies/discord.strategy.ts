...
export class DiscordStrategy extends PassportStrategy(Strategy, "discord") {
    ...
    async validate(
        ...
        // Email fallback removed - emails are no longer used for authentication
        // and caused security issues where users could login as other users with the same email
