...
@Index("team_doubles_assistant_general_manager_id_unique", ["doublesAssistantGeneralManagerId"], {
    unique: true,
})
...
@Index("team_standard_assistant_general_manager_id_unique", ["standardAssistantGeneralManagerId"], {
    unique: true,
})
