import {
    createUnionType, Field, Float, InputType, Int, ObjectType,
} from "@nestjs/graphql";
import {z} from "zod";
...
export const EloRedistributionSchema = z.array(z
