...
describe('SprocketRatingService', () => {
  ...
  it("GT's SR Test #1, Fresh", () => {
    ...
    expect(Math.round(service.calcSprocketRating(input).opi * 10.0) / 10.0).toStrictEqual(
      result.opi,
    );
    expect(Math.round(service.calcSprocketRating(input).dpi * 10.0) / 10.0).toStrictEqual(
      result.dpi,
    );
    expect(Math.round(service.calcSprocketRating(input).gpi * 10.0) / 10.0).toStrictEqual(
      result.gpi,
    );
  });
  ...
  it("Nigel's 3s Test #1", () => {
    ...
    expect(Math.round(service.calcSprocketRating3s(input).opi * 10.0) / 10.0).toStrictEqual(
      result.opi,
    );
    expect(Math.round(service.calcSprocketRating3s(input).dpi * 10.0) / 10.0).toStrictEqual(
      result.dpi,
    );
    expect(Math.round(service.calcSprocketRating3s(input).gpi * 10.0) / 10.0).toStrictEqual(
      result.gpi,
    );
  });
