...
import type {FeatureCode} from "$db/game/feature/feature.enum";
...
export class GameFeatureService {
    ...
    async disableFeature(
        ...
        if (
            allGameFeatures.some(gameFeature => gameFeature.feature.dependencies.some(dep => dep.code === code)
          && gameFeature.enabledOrgs.some(orgEnabledFeature => orgEnabledFeature.organization.id === organizationId))
