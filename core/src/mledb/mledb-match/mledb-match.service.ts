...
export class MledbMatchService {
    constructor(
        @InjectRepository(MLE_Fixture, config.mledb.name) private readonly fixtureRepo: Repository<MLE_Fixture>,
        @InjectRepository(MLE_Team, config.mledb.name) private readonly teamRepo: Repository<MLE_Team>,
        @InjectRepository(MLE_TeamToCaptain, config.mledb.name) private readonly teamCaptainRepo: Repository<MLE_TeamToCaptain>,
